...
function LoginScreen() {
    ...
    return (
        <View style={loginStyles.container}>
            ...
            />
            {errors.email && <Text style={loginStyles.errors}>{errors.email.message}</Text>}
            ...
            <View style={loginStyles.passwordRow}>
                ...
                <Pressable onPress={() => setSecure(!secure)} style={loginStyles.iconBtn}>
                    <Icon
            ...
            {errors.password && <Text style={loginStyles.errors}>{errors.password.message}</Text>}
